...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Home repair requests, handyman work, leak repair help, drywall, doors, cabinets, and property maintenance from Chattanooga to Knoxville.",
  path: "/",
      ...
      <section className="hero">
        <div className="shell hero-layout">
          <div className="hero-copy hero-copy-tile">
            <p className="eyebrow">Home Repair Requests</p>
            <h1>Home Repair, Handyman, Leaks, Doors, Drywall, Cabinets, and Carpentry from Chattanooga to Knoxville</h1>
            <p>
              {business.tagline} We handle repair requests, leak repair
          ...
          <aside className="hero-service-panel" aria-label="Start a home service request">
            ...
            <h2>Need repair help? Call or send details now.</h2>
            <p>
              We take repair requests for leaks, storm damage, damaged doors or
              windows, drywall damage, plumbing fixture problems, and
              electrical fixture issues.
            </p>
            <div className="hero-service-actions">
              <a className="btn" href={`tel:${business.primaryPhoneRaw}`}>
                Call {business.primaryPhoneDisplay}
              </a>
              <Link className="btn-outline" href="/contact#photo-repair-request">
                Send Repair Details
              </Link>
            </div>
        ...
        <div className="shell stat-strip" aria-label="Timber and Testament service proof">
          ...
          <div className="stat">
            <strong>Local</strong>
            Family-owned crews serving your neighborhood.
          </div>
        </div>
      </section>
      ...
      <section className="section section-tight">
        <div className="shell">
          <div className="section-head">
            ...
            <p>
              Fast paths for common repair searches: plumbing leaks, electrical
              fixture problems, drywall repair, door repair, window repair,
              cabinet installation, storm damage, property maintenance, and
              everyday handyman repairs.
            </p>
          </div>
      ...
      <section className="section">
        <div className="shell home-split">
          <article className="card">
            ...
            <p>
              Our home repair, handyman, and improvement services are built
              for clear communication, long-term function, clean finish
